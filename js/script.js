...
const translations = {
  ...
  es: {
    ...
    "hero.title1": "Crea, repara e innova",
    "hero.title2": "sin límites.",
    "hero.subtitle":
    ...
    "about.text":
      "Valadal es una empresa tecnológica construida sobre dos divisiones, reparación y soluciones digitales, con una idea: entender el problema, encontrar la solución y hacer que funcione.",
    "about.button": "Conoce más →",


    "workPage.eyebrow": "Proyectos",
    "workPage.title": "Trabajo real. Soluciones reales.",
    "workPage.lead":
      "Estamos construyendo este portafolio proyecto por proyecto. Todo lo que ves aquí está marcado como ejemplo hasta que lo reemplacemos con trabajos reales fotografiados.",
    "workPage.filter.all": "Todos",
    "workPage.tag": "Proyecto de ejemplo",
    "workPage.item1": "PlayStation 5 — reparación de puerto HDMI",
    "workPage.item2": "MacBook Pro — diagnóstico de tarjeta lógica",
    "workPage.item3": "iPhone — cambio de pantalla",
    "workPage.item4": "Negocio local — rediseño de sitio web",
    "workPage.item5": "Control de Xbox — reparación de stick drift",
    "workPage.item6": "Computadora armada a la medida",
    "workPage.item7": "Herramienta interna — automatización de procesos",
    "workPage.item8": "Dispositivo Android — batería y diagnóstico",
    "workPage.item9": "Banco de diagnóstico completo",
    "workPage.cta.title": "¿Quieres que tu proyecto aparezca aquí?",

    "contactPage.eyebrow": "Contacto",
    "contactPage.title": "Hagamos que funcione.",
    "contactPage.lead":
      "Cuéntanos qué necesitas reparar, o qué quieres construir. Te respondemos lo antes posible.",
    "contactPage.whatsapp.title": "WhatsApp",
    "contactPage.whatsapp.link": "Escríbenos por WhatsApp",
    "contactPage.email.title": "Correo",
    "contactPage.location.title": "Ubicación",
    "contactPage.location.value": "Guadalajara, Jalisco, México",
    "contactPage.hours.title": "Horario de atención",
    "contactPage.hours.value": "Lunes a viernes · 10:00 – 19:00",
    "contactPage.form.name": "Nombre",
    "contactPage.form.namePh": "Tu nombre",
    "contactPage.form.phone": "Teléfono",
    "contactPage.form.phonePh": "Tu número de teléfono",
    "contactPage.form.email": "Correo",
    "contactPage.form.emailPh": "tu@correo.com",
    "contactPage.form.service": "Servicio",
    "contactPage.form.servicePh": "Selecciona un servicio",
    ...
    "contactPage.form.submit": "Enviar solicitud →",
    "contactPage.form.success":
      "✓ Gracias — recibimos tu solicitud. Te contactamos muy pronto.",

    "nav.build": "Armado",

    "buildTeaser.eyebrow": "Armado y Creación",
    "buildTeaser.title": "Construimos tecnología para necesidades reales.",
    "buildTeaser.text":
      "En VALADAL no solo reparamos dispositivos. También diseñamos y construimos soluciones tecnológicas desde cero, combinando hardware, electrónica, computación y sistemas para crear equipos y proyectos adaptados a cada necesidad.",
    "buildTeaser.text2":
      "Desde una computadora personalizada hasta un servidor o un sistema electrónico completo.",
    "buildTeaser.p1": "Computadoras y workstations",
    "buildTeaser.p2": "Servidores e infraestructura",
    "buildTeaser.p3": "Electrónica y sistemas embebidos",
    "buildTeaser.p4": "Automatización y prototipos",
    "buildTeaser.button": "Explorar armado →",

    "build.page.eyebrow": "Creación",
    "build.page.title": "Construimos tecnología para necesidades reales.",
    "build.page.lead":
      "En VALADAL no solo reparamos dispositivos. También diseñamos y construimos soluciones tecnológicas desde cero, combinando hardware, electrónica, computación y sistemas para crear equipos y proyectos adaptados a cada necesidad.",
    "build.page.note":
      "Desde una computadora personalizada hasta un servidor o un sistema electrónico completo.",

    "build.nav.label": "Ve directo a lo que quieres construir",
    "build.nav.pc": "Computadoras",
    "build.nav.servers": "Servidores",
    "build.nav.electronics": "Electrónica",
    "build.nav.embedded": "Sistemas embebidos",
    "build.nav.control": "Sistemas de control",
    "build.nav.cooling": "Refrigeración",
    "build.nav.power": "Alimentación",
    "build.nav.automation": "Automatización",

    "build.pc.eyebrow": "01 — Creación de computadoras",
    "build.pc.title": "PCs construidas según tus necesidades.",
    "build.pc.lead":
      "Creamos computadoras personalizadas seleccionando cada componente de acuerdo con el uso que tendrá el equipo.",
    "build.pc.uses.title": "Equipos para cada uso",
    "build.pc.parts.title": "Personalización de componentes",
    "build.pc.thermal.title": "Refrigeración",
    "build.pc.thermal.sub":
      "Podemos trabajar con refrigeración por aire o refrigeración líquida, dependiendo de los requerimientos del equipo.",

    "build.servers.eyebrow": "02 — Creación de servidores",
    "build.servers.title": "Infraestructura creada para tu proyecto.",
    "build.servers.lead":
      "Diseñamos y armamos servidores de acuerdo con las necesidades de una empresa, proyecto o sistema.",
    "build.servers.uses.title": "Configuraciones que podemos armar",
    "build.servers.factors.title": "Cómo definimos la configuración",
    "build.servers.factors.sub":
      "La configuración se determina considerando factores como capacidad, rendimiento, almacenamiento, redundancia, refrigeración y crecimiento futuro.",

    "build.electronics.eyebrow": "03 — Electrónica",
    "build.electronics.title": "Del circuito más sencillo a sistemas complejos.",
    "build.electronics.lead":
      "Diseñamos y construimos sistemas electrónicos personalizados, desde proyectos básicos hasta soluciones más avanzadas.",
    "build.electronics.basic.title": "Electrónica básica",
    "build.electronics.advanced.title": "Electrónica avanzada",

    "build.embedded.eyebrow": "04 — Sistemas embebidos",
    "build.embedded.title": "Hardware que piensa, mide y actúa.",
    "build.embedded.lead":
      "Creamos sistemas donde el hardware y el software trabajan juntos. Desarrollamos proyectos con plataformas y microcontroladores capaces de medir, procesar, decidir y actuar.",
    "build.embedded.flow1": "Medir",
    "build.embedded.flow2": "Procesar",
    "build.embedded.flow3": "Decidir",
    "build.embedded.flow4": "Actuar",
    "build.embedded.examples.title": "Algunos ejemplos",

    "build.control.eyebrow": "05 — Sistemas de control",
    "build.control.title": "Tecnología diseñada para controlar el mundo físico.",
    "build.control.lead":
      "Creamos sistemas capaces de monitorear y controlar diferentes variables físicas, combinando sensores, actuadores, microcontroladores, electrónica y software.",
    "build.control.vars.title": "Variables que podemos controlar",

    "build.cooling.eyebrow": "06 — Sistemas de refrigeración",
    "build.cooling.title": "Control térmico para equipos y proyectos.",
    "build.cooling.lead":
      "Diseñamos soluciones de refrigeración y control térmico para diferentes aplicaciones. La solución se adapta al nivel de temperatura, espacio, consumo y aplicación del proyecto.",
    "build.cooling.card.title": "Soluciones térmicas",
    "build.cooling.equipment.title": "Gestión térmica para equipos",

    "build.power.eyebrow": "07 — Fuentes y sistemas de alimentación",
    "build.power.title": "Energía diseñada para el sistema.",
    "build.power.lead":
      "Creamos o integramos sistemas relacionados con la alimentación eléctrica de proyectos electrónicos y computacionales.",
    "build.power.card.title": "Alimentación y regulación",

    "build.auto.eyebrow": "08 — Automatización física",
    "build.auto.title": "Convertimos procesos físicos en sistemas inteligentes.",
    "build.auto.lead":
      "Creamos soluciones capaces de responder automáticamente a diferentes condiciones.",
    "build.auto.ex1.title": "Ejemplo — control térmico",
    "build.auto.ex1.text":
      "El sensor detecta la temperatura, el controlador procesa la información y el sistema activa la ventilación.",
    "build.auto.ex2.title": "Ejemplo — iluminación",
    "build.auto.ex2.text":
      "El sensor detecta movimiento, el controlador procesa la señal y el sistema activa la iluminación.",
    "build.auto.where.title": "Dónde se aplica",

    "build.custom.eyebrow": "Prototipos y soluciones personalizadas",
    "build.custom.title": "¿Tienes una idea? Podemos construirla.",
    "build.custom.lead":
      "Trabajamos en la creación de prototipos funcionales para proyectos personales, empresariales, académicos o experimentales — desde una prueba de concepto hasta un prototipo terminado.",
    "build.custom.proto.title": "Prototipos funcionales",
    "build.custom.proto.sub": "Hardware + Electrónica + Programación + Sensores + Control + Software",
    "build.custom.solutions.title": "No todo cabe en una categoría",
    "build.custom.solutions.sub":
      "Si necesitas construir algo que no aparece en nuestra lista, analizamos el proyecto y determinamos qué tecnología necesita.",
    "build.custom.stack.title": "Combinamos diferentes áreas",

    "build.process.eyebrow": "Nuestro proceso",
    "build.process.title": "De la idea al sistema terminado.",
    "build.process.step1.title": "Idea",
    "build.process.step1.text": "Nos cuentas qué quieres crear o qué problema necesitas solucionar.",
    "build.process.step2.title": "Diseño",
    "build.process.step2.text": "Definimos cómo funcionará el sistema y qué componentes necesita.",
    "build.process.step3.title": "Construcción",
    "build.process.step3.text": "Armamos e integramos hardware, electrónica y software.",
    "build.process.step4.title": "Pruebas",
    "build.process.step4.text": "Probamos el funcionamiento y realizamos los ajustes necesarios.",
    "build.process.step5.title": "Entrega",
    "build.process.step5.text": "Entregamos el sistema terminado y, cuando corresponde, documentación y configuración.",

    "build.closing.eyebrow": "Creación VALADAL",
    "build.closing.title": "Construimos más que dispositivos.",
    "build.closing.line": "Si existe una forma de construirlo, podemos empezar por diseñarla.",

    "build.cta.title": "Cuéntanos qué quieres crear.",

    "workPage.nav.label": "Filtra por tipo de trabajo",
    "workPage.filter.build": "Armado",

    "workPage.gallery.eyebrow": "Galería",
    "workPage.gallery.title": "Lo que sale del taller.",
    ...
    "workPage.r1.text":
      "Llevé mi PC porque se apagaba sola y ya me habían dicho que no tenía arreglo. La revisaron a fondo, encontraron el problema real y me explicaron todo antes de tocar nada.",
    "workPage.r1.name": "Cliente de ejemplo",
    "workPage.r1.service": "Reparación · Computadoras",

    "workPage.r2.text":
      "Me armaron una computadora para edición de video dentro de mi presupuesto. Consiguieron componentes de segunda mano revisados y quedó mucho mejor de lo que esperaba.",
    "workPage.r2.name": "Cliente de ejemplo",
    "workPage.r2.service": "Armado · PC personalizada",

    "workPage.r3.text":
      "El puerto HDMI de mi consola dejó de funcionar. Me dieron diagnóstico el mismo día y me la entregaron funcionando. El trabajo por dentro quedó impecable.",
    "workPage.r3.name": "Cliente de ejemplo",
    "workPage.r3.service": "Reparación · Gaming",

    "workPage.r4.text":
      "Nos hicieron el sitio web del negocio y además automatizaron el registro de pedidos. Entendieron el proceso antes de proponer la solución.",
    "workPage.r4.name": "Cliente de ejemplo",
    "workPage.r4.service": "Digital · Web y automatización",

    "workPage.r5.text":
      "Cambio de pantalla de iPhone. Precio claro desde el inicio, sin sorpresas, y me explicaron qué pieza iban a usar y por qué.",
    "workPage.r5.name": "Cliente de ejemplo",
    "workPage.r5.service": "Reparación · Smartphones",

    "workPage.r6.text":
      "Le dieron mantenimiento a los servidores de la oficina. Bajaron las temperaturas y nos dejaron documentado todo lo que hicieron.",
    "workPage.r6.name": "Cliente de ejemplo",
    "workPage.r6.service": "Reparación · Servidores",

    "contactPage.quick.whatsapp": "Escríbenos por WhatsApp",
    "contactPage.quick.email": "Mándanos un correo",

    "contactPage.methods.eyebrow": "Cómo encontrarnos",
    "contactPage.methods.title": "Elige el canal que te quede mejor.",

    "contactPage.form.eyebrow": "Cuéntanos",
    "contactPage.form.title": "Escríbenos y te respondemos.",

    "contactPage.next.eyebrow": "Qué sigue",
    "contactPage.next.title": "Qué pasa después de que nos escribes.",
    "contactPage.next.s1.title": "Te leemos",
    "contactPage.next.s1.text": "Revisamos tu mensaje y, si hace falta, te preguntamos un par de cosas para entender bien el caso.",
    "contactPage.next.s2.title": "Te damos un diagnóstico",
    "contactPage.next.s2.text": "Te decimos qué creemos que pasa, qué opciones tienes y cuánto costaría cada una.",
    ...
    "footer.tagline": "Crea, repara e innova sin límites.",
  ...
  en: {
    ...
    "hero.title1": "Create, repair and innovate",
    "hero.title2": "without limits.",
    "hero.subtitle":
    ...
    "about.text":
      "Valadal is a technology company built on two divisions, repair and digital solutions, with one idea: understand the problem, find the solution, make it work.",
    "about.button": "Learn more →",


    "workPage.eyebrow": "Work",
    "workPage.title": "Real work. Real solutions.",
    "workPage.lead":
      "We're building this portfolio project by project. Everything here is marked as example work until it's replaced with real, photographed jobs.",
    "workPage.filter.all": "All",
    "workPage.tag": "Example project",
    "workPage.item1": "PlayStation 5 — HDMI port repair",
    "workPage.item2": "MacBook Pro — logic board diagnostics",
    "workPage.item3": "iPhone — screen replacement",
    "workPage.item4": "Local business — website redesign",
    "workPage.item5": "Xbox controller — stick drift repair",
    "workPage.item6": "Custom PC build",
    "workPage.item7": "Internal tool — workflow automation",
    "workPage.item8": "Android device — battery & diagnostics",
    "workPage.item9": "Full diagnostic bench setup",
    "workPage.cta.title": "Want your project featured here?",

    "contactPage.eyebrow": "Contact",
    "contactPage.title": "Let's make it work.",
    "contactPage.lead":
      "Tell us what needs fixing, or what you want to build. We'll get back to you as soon as we can.",
    "contactPage.whatsapp.title": "WhatsApp",
    "contactPage.whatsapp.link": "Message us on WhatsApp",
    "contactPage.email.title": "Email",
    "contactPage.location.title": "Location",
    "contactPage.location.value": "Guadalajara, Jalisco, Mexico",
    "contactPage.hours.title": "Business hours",
    "contactPage.hours.value": "Monday to Friday · 10:00 – 19:00",
    "contactPage.form.name": "Name",
    "contactPage.form.namePh": "Your name",
    "contactPage.form.phone": "Phone",
    "contactPage.form.phonePh": "Your phone number",
    "contactPage.form.email": "Email",
    "contactPage.form.emailPh": "you@email.com",
    "contactPage.form.service": "Service",
    "contactPage.form.servicePh": "Select a service",
    ...
    "contactPage.form.submit": "Send Request →",
    "contactPage.form.success":
      "✓ Thanks — your request was received. We'll be in touch soon.",

    "nav.build": "Build",

    "buildTeaser.eyebrow": "Build & Creation",
    "buildTeaser.title": "We build technology for real needs.",
    "buildTeaser.text":
      "At VALADAL we don't just repair devices. We also design and build technology solutions from scratch, combining hardware, electronics, computing and systems to create equipment and projects adapted to each need.",
    "buildTeaser.text2":
      "From a custom computer to a server or a complete electronic system.",
    "buildTeaser.p1": "Computers and workstations",
    "buildTeaser.p2": "Servers and infrastructure",
    "buildTeaser.p3": "Electronics and embedded systems",
    "buildTeaser.p4": "Automation and prototypes",
    "buildTeaser.button": "Explore build →",

    "build.page.eyebrow": "Creation",
    "build.page.title": "We build technology for real needs.",
    "build.page.lead":
      "At VALADAL we don't just repair devices. We also design and build technology solutions from scratch, combining hardware, electronics, computing and systems to create equipment and projects adapted to each need.",
    "build.page.note":
      "From a custom computer to a server or a complete electronic system.",

    "build.nav.label": "Jump straight to what you want to build",
    "build.nav.pc": "Computers",
    "build.nav.servers": "Servers",
    "build.nav.electronics": "Electronics",
    "build.nav.embedded": "Embedded systems",
    "build.nav.control": "Control systems",
    "build.nav.cooling": "Cooling",
    "build.nav.power": "Power",
    "build.nav.automation": "Automation",

    "build.pc.eyebrow": "01 — Computer builds",
    "build.pc.title": "PCs built around your needs.",
    "build.pc.lead":
      "We create custom computers, selecting every component according to how the machine will actually be used.",
    "build.pc.uses.title": "Machines for every use",
    "build.pc.parts.title": "Component customization",
    "build.pc.thermal.title": "Cooling",
    "build.pc.thermal.sub":
      "We can work with air cooling or liquid cooling, depending on what the build requires.",

    "build.servers.eyebrow": "02 — Server builds",
    "build.servers.title": "Infrastructure built for your project.",
    "build.servers.lead":
      "We design and assemble servers according to the needs of a company, project or system.",
    "build.servers.uses.title": "Configurations we can build",
    "build.servers.factors.title": "How we define the configuration",
    "build.servers.factors.sub":
      "The configuration is determined by factors such as capacity, performance, storage, redundancy, cooling and future growth.",

    "build.electronics.eyebrow": "03 — Electronics",
    "build.electronics.title": "From the simplest circuit to complex systems.",
    "build.electronics.lead":
      "We design and build custom electronic systems, from basic projects to more advanced solutions.",
    "build.electronics.basic.title": "Basic electronics",
    "build.electronics.advanced.title": "Advanced electronics",

    "build.embedded.eyebrow": "04 — Embedded systems",
    "build.embedded.title": "Hardware that thinks, measures and acts.",
    "build.embedded.lead":
      "We create systems where hardware and software work together. We develop projects with platforms and microcontrollers able to measure, process, decide and act.",
    "build.embedded.flow1": "Measure",
    "build.embedded.flow2": "Process",
    "build.embedded.flow3": "Decide",
    "build.embedded.flow4": "Act",
    "build.embedded.examples.title": "Some examples",

    "build.control.eyebrow": "05 — Control systems",
    "build.control.title": "Technology designed to control the physical world.",
    "build.control.lead":
      "We create systems able to monitor and control different physical variables, combining sensors, actuators, microcontrollers, electronics and software.",
    "build.control.vars.title": "Variables we can control",

    "build.cooling.eyebrow": "06 — Cooling systems",
    "build.cooling.title": "Thermal control for equipment and projects.",
    "build.cooling.lead":
      "We design cooling and thermal control solutions for different applications. The solution adapts to the temperature level, space, power draw and application of the project.",
    "build.cooling.card.title": "Thermal solutions",
    "build.cooling.equipment.title": "Thermal management for equipment",

    "build.power.eyebrow": "07 — Power supplies and systems",
    "build.power.title": "Power designed for the system.",
    "build.power.lead":
      "We create or integrate systems related to the electrical supply of electronic and computing projects.",
    "build.power.card.title": "Power and regulation",

    "build.auto.eyebrow": "08 — Physical automation",
    "build.auto.title": "We turn physical processes into intelligent systems.",
    "build.auto.lead":
      "We create solutions able to respond automatically to different conditions.",
    "build.auto.ex1.title": "Example — thermal control",
    "build.auto.ex1.text":
      "The sensor detects temperature, the controller processes the information and the system activates ventilation.",
    "build.auto.ex2.title": "Example — lighting",
    "build.auto.ex2.text":
      "The sensor detects movement, the controller processes the signal and the system activates lighting.",
    "build.auto.where.title": "Where it applies",

    "build.custom.eyebrow": "Prototypes and custom solutions",
    "build.custom.title": "Got an idea? We can build it.",
    "build.custom.lead":
      "We create functional prototypes for personal, business, academic or experimental projects — from proof of concept to a finished prototype.",
    "build.custom.proto.title": "Functional prototypes",
    "build.custom.proto.sub": "Hardware + Electronics + Programming + Sensors + Control + Software",
    "build.custom.solutions.title": "Not everything fits a category",
    "build.custom.solutions.sub":
      "If you need to build something that isn't on our list, we analyze the project and determine what technology it needs.",
    "build.custom.stack.title": "We combine different areas",

    "build.process.eyebrow": "Our process",
    "build.process.title": "From idea to finished system.",
    "build.process.step1.title": "Idea",
    "build.process.step1.text": "You tell us what you want to create or what problem you need to solve.",
    "build.process.step2.title": "Design",
    "build.process.step2.text": "We define how the system will work and what components it needs.",
    "build.process.step3.title": "Construction",
    "build.process.step3.text": "We assemble and integrate hardware, electronics and software.",
    "build.process.step4.title": "Testing",
    "build.process.step4.text": "We test how it performs and make the necessary adjustments.",
    "build.process.step5.title": "Delivery",
    "build.process.step5.text": "We deliver the finished system and, where appropriate, documentation and configuration.",

    "build.closing.eyebrow": "VALADAL Creation",
    "build.closing.title": "We build more than devices.",
    "build.closing.line": "If there's a way to build it, we can start by designing it.",

    "build.cta.title": "Tell us what you want to create.",

    "workPage.nav.label": "Filter by type of work",
    "workPage.filter.build": "Build",

    "workPage.gallery.eyebrow": "Gallery",
    "workPage.gallery.title": "What comes out of the workshop.",
    ...
    "workPage.r1.text":
      "I brought in my PC because it kept shutting down and I'd already been told it couldn't be fixed. They went through it properly, found the actual problem and explained everything before touching anything.",
    "workPage.r1.name": "Example customer",
    "workPage.r1.service": "Repair · Computers",

    "workPage.r2.text":
      "They built me a computer for video editing within my budget. They sourced tested second-hand components and it turned out far better than I expected.",
    "workPage.r2.name": "Example customer",
    "workPage.r2.service": "Build · Custom PC",

    "workPage.r3.text":
      "The HDMI port on my console stopped working. They diagnosed it the same day and handed it back working. The work inside was spotless.",
    "workPage.r3.name": "Example customer",
    "workPage.r3.service": "Repair · Gaming",

    "workPage.r4.text":
      "They built our business website and automated our order logging on top of it. They understood the process before proposing a solution.",
    "workPage.r4.name": "Example customer",
    "workPage.r4.service": "Digital · Web and automation",

    "workPage.r5.text":
      "iPhone screen replacement. Clear pricing from the start, no surprises, and they explained which part they'd use and why.",
    "workPage.r5.name": "Example customer",
    "workPage.r5.service": "Repair · Smartphones",

    "workPage.r6.text":
      "They serviced the office servers. Temperatures came down and they left everything they did documented.",
    "workPage.r6.name": "Example customer",
    "workPage.r6.service": "Repair · Servers",

    "contactPage.quick.whatsapp": "Message us on WhatsApp",
    "contactPage.quick.email": "Send us an email",

    "contactPage.methods.eyebrow": "How to reach us",
    "contactPage.methods.title": "Pick whichever channel suits you.",

    "contactPage.form.eyebrow": "Tell us",
    "contactPage.form.title": "Write to us and we'll get back to you.",

    "contactPage.next.eyebrow": "What's next",
    "contactPage.next.title": "What happens after you write to us.",
    "contactPage.next.s1.title": "We read it",
    "contactPage.next.s1.text": "We go through your message and, if needed, ask a couple of questions to understand the case properly.",
    "contactPage.next.s2.title": "We give you a diagnosis",
    ...
    "footer.tagline": "Create, repair and innovate without limits.",
...
function applyLanguage(language, animate = true) {
  ...
  // Atributos traducibles que NO son textContent:
  // placeholder de inputs/textareas y aria-label de botones.
...
filterButtons.forEach((button) => {
  ...
  button.addEventListener(
    ...
    () => {
      ...
      // Si el loop de énfasis la tenía destacada, se lo quitamos:
      // el estado de "filtro aplicado" manda.
...
// ============================================================
// 10. ÉNFASIS AUTOMÁTICO DE BURBUJAS
// Loop de 4 s que va destacando una burbuja a la vez en
// /repair/, /build/ y /digital/.
//
// Notas de diseño:
// - Solo agrega/quita la clase .is-active. NUNCA hace click ni
//   navega: el zoom vive en el contenido interno de cada
//   burbuja (.repair-bubble__content, .build-bubble__content,
//   .digital-nav__content) para no pelearse con el transform
//   de la animación flotante.
// - Se pausa al pasar el mouse por encima del grupo, para que
//   el usuario pueda leer y hacer click con calma.
// - Se pausa cuando la pestaña no está visible.
// - Se desactiva por completo si el sistema pide menos
//   movimiento (prefers-reduced-motion).
// ============================================================

const BUBBLE_CYCLE_MS = 4000;


// ------------------------------------------------------------
// Detecta qué grupo de burbujas existe en esta página.
// Solo una de las tres va a devolver elementos.
// ------------------------------------------------------------

function getBubbleGroup() {

  // emphasisClass: clase que usa el loop para destacar.
  // skipActive:    si true, el loop salta la burbuja que ya
  //                está seleccionada (caso /work/, donde
  //                .is-active significa "filtro aplicado").

  const groups = [
    {
      selector: ".repair-bubbles .repair-bubble",
      emphasisClass: "is-active",
      skipActive: false
    },
    {
      selector: ".build-bubbles .build-bubble",
      emphasisClass: "is-active",
      skipActive: false
    },
    {
      selector: ".digital-nav a",
      emphasisClass: "is-active",
      skipActive: false
    },
    {
      selector: ".work-filters .work-bubble",
      emphasisClass: "is-emphasis",
      skipActive: true
    }
  ];
  ...
  for (const group of groups) {
    ...
    if (found.length > 1) {
      return {
        ...
        emphasisClass: group.emphasisClass,
        skipActive: group.skipActive
      };
    }
  }
...
const bubbleConfig = getBubbleGroup();


if (bubbleConfig) {

  const bubbleGroup = bubbleConfig.items;
  const emphasisClass = bubbleConfig.emphasisClass;
  const skipActive = bubbleConfig.skipActive;
  ...
  function stepBubbleEmphasis() {
    ...
    // En /work/ la burbuja seleccionada no se destaca: ya tiene
    // su propio estado visual. Buscamos la siguiente que sí
    // se pueda destacar, sin quedarnos en bucle infinito.

    let attempts = 0;

    while (
      skipActive &&
      bubbleGroup[bubbleIndex].classList.contains("is-active") &&
      attempts < bubbleGroup.length
    ) {
    ...
    if (attempts >= bubbleGroup.length) {
      return;
    }

    bubbleGroup[bubbleIndex]
      .classList.add(
        emphasisClass
      );
  ...
  // Escuchamos en el contenedor para que el énfasis no salte
  // mientras el usuario está eligiendo a dónde ir.
  // ----------------------------------------------------------

  const bubbleContainer =
    bubbleGroup[0].parentElement;
  ...
  // ----------------------------------------------------------
  // RESPETA prefers-reduced-motion EN CALIENTE
  // ----------------------------------------------------------
